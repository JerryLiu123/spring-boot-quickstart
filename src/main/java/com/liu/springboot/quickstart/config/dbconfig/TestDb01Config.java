...
@Configuration
@MapperScan(basePackages="com.liu.springboot.quickstart.dao.db01dao, com.liu.springboot.quickstart.dao.basedao", sqlSessionTemplateRef="db01SqlSessionTemplate")
