 ...
 *
 */
	function escapeHeml(s){
		if(s===undefined){
			return s;
		}else{
			s=String(s === null?"":s);
			s = s.replace(/&/g, "&").replace(/</g, "&lt;").replace(/>/g, "&gt;");
			s = s.replace(/&lt;font color='red'&gt;/g, "<font color='red'>").replace(/&lt;\/font&gt;/g, "</font>");
			return s;
		}
	}
(function($){
...
if(col.formatter){
cc.push(col.formatter(escapeHeml(_829),_826,_825));
}else{
cc.push(escapeHeml(_829));
}
}
cc.push("</div>");
cc.push("</td>");
